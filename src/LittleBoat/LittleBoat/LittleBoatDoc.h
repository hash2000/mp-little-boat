...
// LittleBoatDoc.h: интерфейс класса CLittleBoatDoc 
//
...
class CLittleBoatDoc : public CDocument
{
protected: // создать только из сериализации
	CLittleBoatDoc() noexcept;
	DECLARE_DYNCREATE(CLittleBoatDoc)
